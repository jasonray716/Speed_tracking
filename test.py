...
BLOB_LOCKON_DISTANCE_PX = 10 # default = 80
...
# dicts_from_file = []
# with open('road_info.txt','r') as inf:
#     for line in inf:
#         dicts_from_file.append(eval(line))

# print ('======= dicts_from_file =======', dicts_from_file)

## Set up a video capture device (number for webcam, filename for video file input)
# vc = cv2.VideoCapture(0)
vc = cv2.VideoCapture('videos/session2_right.avi') # GOPR0058.MP4
...
while True:
    ...
    # cv2.line(frame, (188, 213), (370, 213), (255, 0, 255), 3)
    # cv2.line(frame, (192, 239), (398, 237), (255, 0, 255), 3)
    # cv2.line(frame, (207, 289), (461, 286), (255, 0, 255), 3)
    # cv2.line(frame, (225, 350), (534, 343), (255, 0, 255), 3)
    # cv2.line(frame, (249, 432), (640, 410), (255, 0, 255), 3)
    # cv2.line(frame, (568, 298), (614, 332), (255, 255, 0), 3)
    # cv2.line(frame, (592, 293), (632, 325), (255, 255, 0), 3)
